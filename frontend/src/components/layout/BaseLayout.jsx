...
export default function BaseLayout({ navItems }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-950">
      ...
      {/* Sidebar - desktop */}
      <aside className="hidden lg:flex lg:flex-col w-64 shrink-0 border-r border-gray-200 dark:border-gray-800">
        <Sidebar navItems={navItems} />
      </aside>

      {/* Sidebar - mobile drawer */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 flex flex-col transform transition-transform duration-200 lg:hidden ${
