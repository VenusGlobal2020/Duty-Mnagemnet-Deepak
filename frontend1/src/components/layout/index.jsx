...
const masterNav = [
  ...
  { to: '/master/notifications', label: 'सूचनाएं', icon: Bell },
...
const superadminNav = [
  ...
  { to: '/superadmin/notifications', label: 'सूचनाएं', icon: Bell },
...
const adminNav = [
  ...
  { to: '/admin/notifications', label: 'सूचनाएं', icon: Bell },
...
const operatorNav = [
  ...
  { to: '/operator/notifications', label: 'सूचनाएं', icon: Bell },
...
const officerNav = [
  ...
  { to: '/officer/notifications', label: 'सूचनाएं', icon: Bell },
